	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) : ?>
				<p class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><a class="thenutshells" href="http://thenutshells.artisticritique.com">thenutshells</a></p>
			<?php else : ?>
				<p class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><a class="thenutshells" href="http://thenutshells.artisticritique.com">thenutshells</a></p>
			<?php
			endif;
